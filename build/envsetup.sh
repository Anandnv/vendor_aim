# aim functions that extend build/envsetup.sh
...
function aim_device_combos()
{
    ...
    T="$(gettop)"
    list_file="${T}/vendor/aim/aim.devices"
    variant="userdebug"
...
function aimremote()
{
    ...
    git remote add aim "git@github.com:AIM-O/$pfx$project"
...
function aim_push()
{
    ...
    git $path_opt push "ssh://${ssh_name}/AIM-O/$proj" "HEAD:refs/for/$branch"
}
...
aim_append_hmm "aimremote" "Add a git remote for matching aim repository"
aim_append_hmm "aospremote" "Add git remote for matching AOSP repository"
aim_append_hmm "cafremote" "Add git remote for matching CodeAurora repository."
